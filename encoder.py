...
message = '11001100110011001' + message + '10101010101010101'
...
for i in range(len(samples_array)):
    if abs(samples_array[i]) > 1000:
        start = i
        break

# encode message by replacing least significant bits with binary from message
